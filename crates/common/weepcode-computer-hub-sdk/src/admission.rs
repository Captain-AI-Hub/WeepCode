...
/// Numeric JSON-RPC code for overload rejection (`weepcode-tool-protocol`
...
const GLOBAL_MAX_INFLIGHT_ENV: &str = "WEEPCODE_TOOL_SERVER_GLOBAL_MAX_INFLIGHT";
...
/// `WEEPCODE_TOOL_SERVER_GLOBAL_MAX_INFLIGHT` when present and parseable as a
