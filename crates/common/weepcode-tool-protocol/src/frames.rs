...
pub struct ToolCallResult {
    ...
    /// this crate must not depend on `weepcode-tool-runtime`. Sampler-side wire
...
/// `weepcode_computer_hub_core::registry::ToolSessionBindOutcome`, with one
...
pub struct ToolsListResult {
    pub tools: Vec<weepcode_tool_types::ToolDescription>,
}
