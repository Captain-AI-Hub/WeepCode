...
fn map_block(block: weepcode_tool_protocol::McpBlock) -> ContentBlock {
    use weepcode_tool_protocol::McpBlock;
    match block {
...
pub fn error_from_envelope(err: weepcode_tool_protocol::JsonRpcError) -> ToolError {
