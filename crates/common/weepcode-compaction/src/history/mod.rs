...
//! string/text manipulation. Harness-bound extraction (WeepCode chat's
//! `WeepcodeConversation` traversal, `ChatCompletionRequest` user-message
//! extraction, `WeepcodeMessage` assembly) stays in the harness crate.
