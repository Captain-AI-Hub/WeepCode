//! Unified MCP adapter for the WeepCode Computer Hub.
//!
...
//! tools, and produces [`ToolServerHandler`](weepcode_computer_hub_sdk::ToolServerHandler)
//! implementations that can be registered with a hub
//! [`ToolServerBuilder`](weepcode_computer_hub_sdk::ToolServerBuilder).
//!
//! # Architecture
//!
//! ```text
