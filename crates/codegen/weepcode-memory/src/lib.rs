...
//! WeepCode to persist important information across sessions. Memory files are
//! stored under `~/.weepcode/memory/` with workspace-scoped subdirectories
...
//! `WEEPCODE_MEMORY=1` environment variable. When disabled, this crate
