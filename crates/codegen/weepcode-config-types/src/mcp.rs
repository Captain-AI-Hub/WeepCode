//! MCP server configuration value types, extracted from weepcode-shell
...
use weepcode_mcp::oauth_config::McpOAuthConfig;
...
impl RelaySyncConfig {
    ...
    pub fn is_enabled(&self) -> bool {
        if let Ok(env_val) = std::env::var("WEEPCODE_RELAY_SYNC_ENABLED") {
