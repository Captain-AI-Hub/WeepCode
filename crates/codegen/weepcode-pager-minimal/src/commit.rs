...
use weepcode_pager::appearance::AppearanceConfig;
use weepcode_pager::minimal_api;
use weepcode_pager::render::Renderable;
use weepcode_pager::scrollback::block::RenderBlock;
use weepcode_pager::scrollback::blocks::ToolCallBlock;
use weepcode_pager::scrollback::entry::{EntryId, ScrollbackEntry};
...
mod tests {
    ...
    fn terminal_native_lock_paints_only_native_colors() {
        use ratatui::buffer::Buffer;
        use weepcode_pager::theme::cache as theme_cache;
        ...
        impl Drop for LockReset {
            fn drop(&mut self) {
                weepcode_pager::theme::cache::set_terminal_native_lock(false);
            }
        }
    ...
    fn committed_edit_keeps_diff_line_backgrounds() {
        ...
        use ratatui::layout::Rect;
        use similar::ChangeTag;
        use weepcode_pager::diff::DiffLine;
