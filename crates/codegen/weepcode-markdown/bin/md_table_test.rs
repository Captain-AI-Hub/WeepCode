...
//!
//! Run with:
//!   cargo run -p weepcode-markdown --features playground --bin md-table-test
//!
//! Controls:
...
use weepcode_markdown::{
    MarkdownBuffers, MarkdownStyle, StreamingMarkdownRenderer,
    render_markdown_ratatui_with_buffers_width,
};
use weepcode_ratatui_textarea::{TextArea, TextAreaState};

// ── Tokyo Night Storm palette (matches weepcode-pager) ──────────────────────
