...
//!
//! Run with: cargo test -p weepcode-mcp --test repro_sse_flood -- --nocapture
...
use weepcode_mcp::mcp_http_client::{McpHttpClient, WarnBudget};
use weepcode_mcp::rmcp::ServiceExt;
use weepcode_mcp::rmcp::transport::StreamableHttpClientTransport;
use weepcode_mcp::rmcp::transport::streamable_http_client::StreamableHttpClientTransportConfig;
