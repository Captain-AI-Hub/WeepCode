...
//!
//! Security: the subprocess is spawned with [`weepcode_tty_utils::detach_std_command`]
//! (TTY/session detach) + [`weepcode_tty_utils::pager_env`] + null stdio, source is
