...
//!
//! ```text
//! <cwd>/.weepcode/rewind-checkpoints/
...
/// Directory (under `<cwd>/.weepcode`) holding every session's checkpoint store.
...
pub(crate) struct CheckpointStore {
    /// Per-session store directory: `<cwd>/.weepcode/rewind-checkpoints/<session_id>`.
    dir: PathBuf,
