//! AcpFsAdapter: implements `weepcode-tools::AsyncFileSystem` using ACP gateway calls.
//!
//! This adapter enables file tool execution over ACP (remote filesystem).
//! It translates weepcode-tools' `AsyncFileSystem` trait into ACP protocol calls:
...
use weepcode_tools::computer::types::{AsyncFileSystem, ComputerError};

/// Wraps weepcode-shell's ACP gateway to satisfy weepcode-tools' AsyncFileSystem.
///
