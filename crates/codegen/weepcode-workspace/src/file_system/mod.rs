...
// its wire types live in `weepcode_workspace_types::rpc::fs` (the `ClientFs*`
...
pub use weepcode_workspace_types::rpc::fs::FsReadEncoding;
...
pub use weepcode_workspace_types::rpc::search::{ClientId, ContentSearchRequest, TargetClientId};
