//! Public event types — the wire contract for `weepcode-fsnotify`.
//!
...
//! translator (in `weepcode-workspace`) maps these to
...
/// Aligned with `weepcode_workspace_types::FsEventKind` (identity map at
