...
//! }
//!
//! weepcode_crash_handler::install(weepcode_crash_handler::CrashHandlerConfig {
...
/// `$WEEPCODE_HOME` they must not be world-readable.
...
mod tests {
    ...
    fn check_previous_crash_returns_none_when_no_file() {
        let dir = PathBuf::from("/tmp/weepcode-crash-handler-test-nonexistent");
