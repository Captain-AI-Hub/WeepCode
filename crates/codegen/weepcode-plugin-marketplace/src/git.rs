...
//! Cache root: `~/.weepcode/marketplace-cache/<url-hash>/`
...
pub fn default_cache_root() -> PathBuf {
    weepcode_config::weepcode_home().join("marketplace-cache")
}
...
mod tests {
    ...
    fn cache_hash_is_deterministic() {
        let url = "https://github.com/weepcode-org/weepcode-plugin-marketplace.git";
    ...
    #[test]
    fn default_cache_root_under_weepcode() {
