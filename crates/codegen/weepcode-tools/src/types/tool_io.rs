...
use crate::implementations::weepcode_build::ask_user_question::AskUserQuestionInput;
use crate::implementations::weepcode_build::enter_plan_mode::EnterPlanModeInput;
use crate::implementations::weepcode_build::exit_plan_mode::ExitPlanModeInput;
use crate::implementations::weepcode_build::grep::GrepSearchInput;
use crate::implementations::weepcode_build::image_edit::ImageEditInput;
use crate::implementations::weepcode_build::image_gen::ImageGenInput;
use crate::implementations::weepcode_build::list_dir::ListDirInput;
use crate::implementations::weepcode_build::read_file::ReadFileInput;
use crate::implementations::weepcode_build::search_replace::SearchReplaceInput;
use crate::implementations::weepcode_build::todo::TodoWriteInput;
use crate::implementations::weepcode_build::update_goal::UpdateGoalInput;
...
use weepcode_tool_types::TaskToolInput;
use weepcode_tool_types::WaitTasksToolInput;
...
pub enum ToolInput {
    ...
    HashlineEdit(crate::implementations::weepcode_build_hashline::edit::types::HashlineEditInput),
    ...
    Lsp(LspToolInput),
    Monitor(crate::implementations::weepcode_build::monitor::types::MonitorInput),
    SchedulerCreate(
        crate::implementations::weepcode_build::scheduler::create::SchedulerCreateInput,
    ),
    SchedulerDelete(
        crate::implementations::weepcode_build::scheduler::delete::SchedulerDeleteInput,
    ),
