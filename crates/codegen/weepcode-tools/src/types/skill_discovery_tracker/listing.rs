...
///
/// `"/path/.weepcode/skills/my-skill/SKILL.md"` -> `"/path/.weepcode/skills/"`
        ...
        skills
            ...
            .filter(|s| {
                s.enabled
                    ...
                    // Compat mode renders all skills verbatim; only the weepcode
...
mod tests {
    ...
    fn verbatim_bypasses_is_listable_filter() {
        // weepcode-build drops a description-less skill; compat mode renders all.
