...
//!
//! Reuses the core file-reading logic from [`weepcode_build::read_file::run_read_file`]
...
use crate::implementations::weepcode_build::read_file::{ReadFileInput, run_read_file};
...
impl weepcode_tool_runtime::Tool for HashlineReadTool {
    type Args = ReadFileInput;
    type Output = ReadFileOutput;

    fn id(&self) -> weepcode_tool_protocol::ToolId {
        weepcode_tool_protocol::ToolId::new("hashline_read").expect("valid tool id")
    }
...
mod tests {
    ...
    use crate::implementations::weepcode_build::read_file::{MAX_LINES_READ, ReadFileTool};
    ...
    /// file content independently of weepcode_build `read_file`).
    #[tokio::test]
