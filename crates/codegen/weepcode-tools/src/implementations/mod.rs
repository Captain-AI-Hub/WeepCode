...
pub mod use_tool;
pub mod web_search;
pub mod weepcode_build;
pub mod weepcode_build_concise;
pub mod weepcode_build_hashline;
...
pub use weepcode_build::bash::{BashError, BashToolInput};
pub use weepcode_build::{
