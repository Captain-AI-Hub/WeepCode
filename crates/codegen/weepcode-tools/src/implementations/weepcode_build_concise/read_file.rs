...
impl weepcode_tool_runtime::Tool for ReadFileConciseTool {
    ...
    async fn run(
        ...
        // WeepcodeBuildConcise is not version-managed — always pass None.
...
mod tests {
    ...
    use crate::implementations::weepcode_build::read_file::ReadFileTool;
