...
crate::register_resource!("weepcode_build", "ListDir", ListDirParams);
...
impl weepcode_tool_runtime::Tool for ListDirTool {
...
mod tests {
    ...
    fn tool_name_and_description() {
        ...
        let tool = ListDirTool;
        assert_eq!(weepcode_tool_runtime::Tool::id(&tool).as_str(), "list_dir");
