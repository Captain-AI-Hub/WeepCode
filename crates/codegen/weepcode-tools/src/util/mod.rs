...
pub use env::{
    WEEPCODE_AGENT_ENV, WEEPCODE_AGENT_ENV_VALUE, apply_weepcode_agent_marker, pager_env,
};
...
pub use weepcode_home::{weepcode_application, weepcode_home};
pub use weepcode_tty_utils::detach_std_command;
