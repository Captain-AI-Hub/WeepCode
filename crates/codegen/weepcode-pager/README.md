...
- [Hook Examples](../weepcode-hooks/examples/README.md) — sample hooks for common workflows
- [Hooks Crate (`weepcode-hooks`)](../weepcode-hooks/) — hook runtime, event types, and execution engine
- [Plugin Marketplace Crate (`weepcode-plugin-marketplace`)](../weepcode-plugin-marketplace/) — marketplace source loading, scanning, and install
