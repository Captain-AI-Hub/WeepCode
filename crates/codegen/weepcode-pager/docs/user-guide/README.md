...
Automate, script, and integrate WeepCode with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `weepcode -p`, output formats, CI/CD integration, and piping |
