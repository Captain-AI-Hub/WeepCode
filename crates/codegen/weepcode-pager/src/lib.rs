...
// minimal rendering lives in the sibling `weepcode-pager-minimal` crate; these
...
// `weepcode-pager-render`. Re-exported at the crate root so existing
// `crate::<module>::...` references throughout the pager keep resolving.
pub use weepcode_pager_render::{
