...
pub struct QueuePane {
    ...
    /// `bg_highlight` — e.g. WeepcodeNight's dark band leaking into WeepcodeDay).
...
impl QueuePane {
    ...
    pub fn render(
        ...
        // at construction (default WeepcodeNight, dark) after the user switches —
        // painting a dark band on a light WeepcodeDay canvas.
...
mod tests {
    ...
    fn yank_selected_multiline_copies_full_text() {
        ...
        use weepcode_ratatui_textarea::ClipboardProvider;
