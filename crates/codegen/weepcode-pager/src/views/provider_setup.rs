...
//! in `config.toml`. Replaces the old WeepCode browser-OAuth login wall.
...
pub fn render_provider_setup_form(
    ...
    let mut format_spans = vec![
        focused_marker(ProviderSetupField::Format),
        pad_label("Format"),
    ];
