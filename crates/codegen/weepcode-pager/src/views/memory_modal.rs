...
pub fn build_entries(
    files: Vec<weepcode_shell::extensions::notification::MemoryFileInfo>,
) -> Vec<MemoryFileEntry> {
...
mod tests {
    ...
    fn file_label_extracts_filename() {
        assert_eq!(
            file_label("/home/user/.weepcode/memory/MEMORY.md"),
            "MEMORY.md"
        );
        assert_eq!(
            file_label("/workspace/.weepcode/memory/sessions/2026-01-15-fix-bug.md"),
    ...
    fn build_entries_groups_by_source() {
        use weepcode_shell::extensions::notification::MemoryFileInfo;
