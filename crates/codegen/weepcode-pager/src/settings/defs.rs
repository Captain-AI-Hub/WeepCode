...
const SCREEN_MODE_CHOICES: &[EnumChoice] = &[
    EnumChoice {
        ...
        display: "Fullscreen",
        description: "Open plain weepcode in the standard fullscreen TUI. Default when unset.",
    },
    EnumChoice {
        canonical: "minimal",
        display: "Minimal",
        description: "Open plain weepcode in scrollback-native (minimal) mode.",
    },
];
...
pub fn default_settings() -> Vec<SettingMeta> {
    ...
    vec![
        ...
        SettingMeta {
            ...
            description: "How plain weepcode opens next time: Fullscreen (default when unset) or \
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` resolved to "weepcodenight".
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "weepcodenight".
                default: "weepcodenight",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "weepcodeday".
                default: "weepcodeday",
                choices: CONCRETE_THEME_CHOICES,
                supports_preview: true,
            },
        ...
        SettingMeta {
            ...
            keywords: &["model", "default", "agent", "llm", "weepcode", "switch"],
        ...
        // The `WEEPCODE_PROMPT_SUGGESTIONS` env var overrides at runtime.
        SettingMeta {
        ...
        SettingMeta {
            ...
            owner: SettingOwner::Shell,
            label: "SSH wrap",
            description: "At session load over SSH, recommend `weepcode wrap ssh` for \
