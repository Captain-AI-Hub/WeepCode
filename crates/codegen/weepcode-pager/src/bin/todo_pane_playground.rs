...
//!
//! ```text
//! cargo run -p weepcode-pager --bin todo-pane-playground
//! ```
//!
...
use weepcode_pager::views::todo_pane::TodoPane;
use weepcode_shell::tools::{TodoItem, TodoPriority, TodoStatus};
