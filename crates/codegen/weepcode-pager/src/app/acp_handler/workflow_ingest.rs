...
fn upsert_workflow_block(
    ...
    objective: &str,
    status: &str,
    phases: &[weepcode_shell::extensions::notification::WorkflowPhaseInfo],
...
pub(super) fn ingest_workflow_update(agent: &mut AgentView, update: WeepcodeSessionUpdate) -> bool {
    let WeepcodeSessionUpdate::WorkflowUpdated {
        run_id,
        revision,
        name,
        objective,
