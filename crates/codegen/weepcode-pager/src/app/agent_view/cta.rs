...
impl AgentView {
    ...
    pub(crate) fn log_prompt_suggestion_shown_if_visible(&mut self) {
        ...
        weepcode_telemetry::session_ctx::log_event(weepcode_telemetry::events::PromptSuggestion {
            action: weepcode_telemetry::events::PromptSuggestionAction::Shown,
            chars,
            words,
        });
    }
    ...
    pub(in crate::app) fn connect_matched_plugin(&mut self) {
        ...
        weepcode_telemetry::session_ctx::log_event(
            weepcode_telemetry::events::PluginCtaConnectClicked {
        ...
        self.pending_effects
            .push(super::actions::Effect::InstallPluginFromCta {
                agent_id: self.session.id,
                session_id,
                source_url_or_path: weepcode_plugin_marketplace::OFFICIAL_SOURCE_GIT_URL
                    .to_string(),
                plugin_relative_path,
            });
    }
...
mod plugin_cta_notify_tests {
    ...
    fn cta_entry(name: &str) -> weepcode_hooks_plugins_types::MarketplacePluginEntry {
