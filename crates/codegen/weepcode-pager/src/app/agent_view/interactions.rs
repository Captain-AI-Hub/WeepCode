...
impl AgentView {
    ...
    fn submit_question_answers(&mut self, skipped: bool) -> InputOutcome {
        use weepcode_tools::implementations::weepcode_build::ask_user_question::AskUserQuestionExtResponse;
        self.swap_question_freeform();
        ...
        weepcode_telemetry::session_ctx::log_event(weepcode_telemetry::events::PlanSubmit {
...
mod permission_scope_key_tests {
    ...
    fn setup_bash_permission(agent: &mut AgentView) {
        ...
        perm.bash_highlights = Some(
            weepcode_workspace::permission::bash_command_splitting::BashCommandHighlights {
                prefix: vec![],
...
mod question_no_freeform_tests {
    ...
    //! a fixed-choice account action. Regression tests for the bug where clicking
    ...
    fn fixed_choice_question() -> Question {
        ...
        Question {
            question: "Choose how to continue.".into(),
            options: vec![
                opt("Use saved provider", "Continue with current settings"),
                opt("Configure provider", "Open model setup"),
            ],
