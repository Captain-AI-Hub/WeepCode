            ...
            MouseEventKind::Down(MouseButton::Left) => {
                    ...
                    && !self.pos_occluded(mouse.column, mouse.row)
                {
                    return InputOutcome::Action(Action::AnnouncementsOpenCta(
                        weepcode_telemetry::events::AnnouncementCtaSurface::Banner,
                    ));
                }
                if self
                    .plugin_cta
                        ...
                        &self.plugin_cta.phase
                {
                    ...
                    if let Err(e) = weepcode_shell::config::add_dismissed_plugin_cta(&plugin_id) {
                        tracing::warn!(
                    ...
                    weepcode_telemetry::session_ctx::log_event(
                        weepcode_telemetry::events::PluginCtaDismissed {
                ...
                {
                    return InputOutcome::Action(Action::AnnouncementsOpenCta(
                        weepcode_telemetry::events::AnnouncementCtaSurface::Header,
                    ));
                }
