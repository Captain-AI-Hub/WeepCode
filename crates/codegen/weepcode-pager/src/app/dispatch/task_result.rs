...
use super::auth::{
    ...
    handle_mcp_setup_submit_done, handle_provider_profile_saved,
};
use super::cta::{
    ...
    match result {
        ...
        TaskResult::ForeignResumeCwdCanonicalized {
                ...
                && let Some(canonical_cwd) = accepted_cwd
            {
                vec![Effect::DetectForeignResumeHint {
                    ...
                    weepcode_home: weepcode_tools::util::weepcode_home::weepcode_home(),
                    launch_token,
                }]
            } else {
                vec![]
        ...
        TaskResult::ChangelogFetched { markdown, entries } => {
            ...
            app.changelog_bullets =
                weepcode_shell::util::changelog::bullets_from_entries(&entries, 3);
            vec![]
        }
        ...
        TaskResult::ProviderProfileSaved { result } => handle_provider_profile_saved(app, result),
