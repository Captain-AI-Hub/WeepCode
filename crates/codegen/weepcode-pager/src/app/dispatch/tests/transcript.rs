...
fn plugins_list_response() -> weepcode_hooks_plugins_types::PluginsListResponse {
    use crate::views::extensions_modal::test_plugin_info;
    weepcode_hooks_plugins_types::PluginsListResponse {
        plugins: vec![
            test_plugin_info(
                "user-tool",
                Some(weepcode_hooks_plugins_types::PluginOrigin::UserWeepcode),
            ),
            test_plugin_info(
                "claude-tool",
                Some(weepcode_hooks_plugins_types::PluginOrigin::UserClaude),
            ),
        ],
    }
}
