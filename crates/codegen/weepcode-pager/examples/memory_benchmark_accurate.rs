...
fn main() {
    ...
    let string_info = create_string_info(1, "general-purpose", "weepcode-3", "researcher");
    let arc_info = create_arc_info(1, "general-purpose", "weepcode-3", "researcher");
    ...
    let shared_models = ["weepcode-3", "weepcode-3-mini"];
