#
# WeepCode CLI installer for PowerShell.
#
...
#
# Usage:
#   $env:WEEPCODE_CLI_DOWNLOAD_BASE_URL="https://downloads.example.com/weepcode"; .\install.ps1
#   $env:WEEPCODE_CLI_DOWNLOAD_BASE_URL="https://downloads.example.com/weepcode"; .\install.ps1 0.1.42
#
