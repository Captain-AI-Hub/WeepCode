//! Criterion benchmarks for the weepcode-pager rendering pipeline.
//!
...
use weepcode_pager::scrollback::render::render_scrolled_entries_with_scratch;
use weepcode_pager::scrollback::wrappers::EntryRenderer;
use weepcode_pager::scrollback::{
