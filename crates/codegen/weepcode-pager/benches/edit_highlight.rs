...
//!
//! ```text
//! cargo bench -p weepcode-pager --bench edit_highlight
//! cargo bench -p weepcode-pager --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use weepcode_pager::diff::{DiffHunk, DiffLine};
use weepcode_pager::scrollback::blocks::tool::{
...
use weepcode_pager::syntax::{Syntect, get_syntect};
