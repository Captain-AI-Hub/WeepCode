...
//! window containing a [`weepcode_mcp::servers::McpClientEventKind::TransportClosed`]
//! or [`weepcode_mcp::servers::McpClientEventKind::HandshakeFailed`] key for a
...
//!    [`weepcode_mcp::servers::start_mcp_server`] sets
...
//!    push and stop.
//! 5. **Already-Empty** — see the [`weepcode_mcp::servers::ClientStateKind::Empty`]
...
use weepcode_mcp::servers::{McpClientEventKind, McpServerName};
