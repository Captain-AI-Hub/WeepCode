...
use weepcode_chat_state::{MEMORY_CONTEXT_CLOSE_TAG, MEMORY_CONTEXT_OPEN_TAG};
use weepcode_sampling_types::ConversationItem;
use weepcode_tools::types::memory_backend::{MemorySearchResult, format_staleness_note};
...
mod tests {
    ...
    fn test_format_memory_reminder_empty_results_is_none() {
        use weepcode_tools::types::memory_backend::MemorySearchResult;
