...
use weepcode_tools::types::output::{ToolOutput, ToolRunResult};
...
fn ok_result(text: &str) -> Result<ToolRunResult, weepcode_tool_runtime::ToolError> {
    Ok(ToolRunResult {
...
fn err(msg: &str) -> Result<ToolRunResult, weepcode_tool_runtime::ToolError> {
...
fn http_err(status: u16, msg: &str) -> Result<ToolRunResult, weepcode_tool_runtime::ToolError> {
    Err(weepcode_tool_runtime::ToolError::new(
...
fn is_auth_tool_error_classification() {
    ...
    let cases: Vec<(bool, weepcode_tool_runtime::ToolError)> = vec![
        ...
        (
            true,
            weepcode_tool_runtime::ToolError::new(
                weepcode_tool_runtime::ToolErrorKind::Custom,
        ...
        // the inference path's gate in weepcode-sampling-types/src/error.rs:
        ...
        (
            true,
            weepcode_tool_runtime::ToolError::invalid_arguments(r#"{"error":"invalid_token"}"#),
        ),
        // Fallback path: case-insensitive "unauthorized" anywhere in
        // the message body.
        (
            true,
            weepcode_tool_runtime::ToolError::invalid_arguments("UNAUTHORIZED"),
        ),
        ...
        (
            ...
            weepcode_tool_runtime::ToolError::not_found(
                weepcode_tool_protocol::ToolId::new("image_gen").expect("valid"),
        ...
        (
            false,
            weepcode_tool_runtime::ToolError::invalid_arguments("request id req_401abc failed"),
        ),
    ];
