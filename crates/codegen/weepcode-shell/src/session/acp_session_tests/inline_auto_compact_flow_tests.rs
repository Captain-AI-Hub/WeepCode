...
async fn test_compact_on_error_triggers_when_tokens_exceed_new_window() {
    ...
    local
        .run_until(async {
            let (gateway_tx, _) = mpsc::unbounded_channel::<weepcode_acp_lib::AcpClientMessage>();
...
async fn test_e2e_idle_resume_refreshes_model_metadata() {
    ...
    local
        .run_until(async {
            ...
            chat_state_handle.update_credentials(weepcode_chat_state::types::Credentials {
            ...
            let actor = SessionActor {
                ...
                auth_manager: {
                    ...
                    mgr.hot_swap(crate::auth::WeepcodeAuth {
