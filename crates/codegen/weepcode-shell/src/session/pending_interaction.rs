...
use crate::extensions::notification::{
    SessionNotification, SessionUpdate as WeepcodeSessionUpdate,
};
...
fn broadcast(gateway: &GatewaySender, session_id: &acp::SessionId, update: WeepcodeSessionUpdate) {
...
impl PendingInteractionGuard {
    ...
    pub fn new(
        ...
        broadcast(
            &gateway,
            &session_id,
            WeepcodeSessionUpdate::PendingInteraction {
    ...
    fn drop(&mut self) {
        ...
        if removed {
            broadcast(
                &self.gateway,
                &self.session_id,
                WeepcodeSessionUpdate::InteractionResolved {
