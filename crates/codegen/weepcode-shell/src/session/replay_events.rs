...
///
/// One-shot WeepCode events (RetryState, ImageCompressed, HookExecution,
/// etc.) take the direct `send_weepcode_notification` path for per-event hooks and persistence.
#[derive(Debug, Clone)]
