...
// weepcode-interjection-core crate so the server-side agent loop can adopt the
...
pub(crate) use weepcode_interjection_core::{
...
pub(crate) type PendingInterjection =
    weepcode_interjection_core::PendingInterjection<acp::ImageContent>;
