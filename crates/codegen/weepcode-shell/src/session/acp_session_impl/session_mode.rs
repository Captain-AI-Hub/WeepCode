...
impl SessionActor {
        ...
        *self.current_prompt_mode.lock() = prompt_mode;
        ...
        if mode.is_plan() {
            ...
            weepcode_telemetry::session_ctx::log_event(
                weepcode_telemetry::events::PlanModeToggled {
                    enabled: true,
                    trigger: weepcode_telemetry::events::PlanModeTrigger::User,
                    turn_in_flight,
    ...
    /// first-entry/reentry distinction), or weepcode's reentry/full variant.
