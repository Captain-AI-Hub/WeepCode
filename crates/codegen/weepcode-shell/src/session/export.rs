...
/// JSON-RPC wrapper for WeepCode extension notifications.
#[derive(Debug, Serialize)]
...
const WEEPCODE_SESSION_UPDATE_METHOD: &str = "_x.ai/session/update";
        ...
        updates
            ...
            .map(|update| match update {
                ...
                SessionUpdate::Xai(notification) => {
                    ExportedMessage::from_weepcode_notification(notification)
                }
            })
            .collect()
    }
