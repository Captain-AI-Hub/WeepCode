...
use weepcode_workflow::{PauseKind, PhaseMeta, WorkflowOutcome};
...
fn capped_pause_message(message: impl Into<String>) -> String {
    ...
    weepcode_tools::util::truncate_str(&message, WORKFLOW_PAUSE_MESSAGE_MAX_BYTES).to_string()
}
    ...
    pub fn apply_outcome(
        ...
        match outcome {
            ...
            WorkflowOutcome::BudgetExceeded { message } => {
                ...
                let hint = if run.state.agents_used >= weepcode_workflow::MAX_AGENT_BUDGET {
