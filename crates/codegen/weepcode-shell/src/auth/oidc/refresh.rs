...
use super::super::WeepcodeAuth;
use super::protocol::{OidcError, OidcUserInfo, build_weepcode_auth, discover, refresh_tokens};
...
pub(crate) async fn oidc_token_exchange(auth: &WeepcodeAuth) -> OidcRefreshResult {
    ...
    let mut new_auth = build_weepcode_auth(tokens, user_info, issuer, client_id);
