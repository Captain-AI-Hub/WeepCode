...
pub(crate) trait ExternalCommandRunner: Send + Sync {
    ...
    fn run_external_command(&self, command: &str) -> Option<WeepcodeAuth>;
}
...
impl RefreshOutcome {
    ...
    pub(crate) fn success(auth: WeepcodeAuth) -> Self {
...
mod tests {
    use super::*;
    use crate::auth::{AuthMode, WeepcodeAuth, WeepcodeComConfig};
