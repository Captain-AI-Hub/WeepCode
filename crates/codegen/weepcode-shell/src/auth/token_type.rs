...
impl TokenType {
    ...
    pub(crate) fn from_auth(auth: Option<&WeepcodeAuth>) -> Self {
        match auth {
            None => Self::None,
    ...
    pub(crate) fn telemetry_kind(self) -> weepcode_telemetry::events::AuthTokenKind {
        use weepcode_telemetry::events::AuthTokenKind as K;
        match self {
