...
//! weepcode-tools. This struct is NOT used for tool execution — it's session infrastructure.
//!
...
use weepcode_workspace::file_system::{AsyncFileSystem, AsyncFsWrapper};
use weepcode_workspace::session::file_state::FileStateHandle;
...
pub struct ToolContext {
    ...
    pub lsp: Option<Arc<dyn weepcode_tools::implementations::lsp::LspBackend>>,
    ...
    pub monitor_event_buffer:
        Option<weepcode_tools::implementations::weepcode_build::task::types::MonitorEventBuffer>,
...
impl ToolContext {
    pub fn new(
        ...
        let session_env = weepcode_workspace::envrc::load_envrc_or_empty_when_trusted(
            cwd.as_path(),
