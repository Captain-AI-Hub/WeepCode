//! Retry utilities — re-exported from `weepcode-tools`.
//!
//! The canonical implementation now lives in `weepcode_tools::retry`.
//! This module re-exports with backward-compatible aliases.

pub use weepcode_tools::retry::BackoffConfig as RetryConfig;
pub use weepcode_tools::retry::{BackoffConfig, execute_with_backoff};
