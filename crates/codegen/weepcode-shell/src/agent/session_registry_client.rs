...
pub struct SessionRegistryClient {
    ...
    base_url: String,
    credentials: crate::util::weepcode_auth_credentials::WeepcodeAuthCredentials,
...
impl SessionRegistryClient {
    pub fn new(base_url: impl Into<String>, user_token: impl Into<String>) -> Self {
        ...
        Self {
            ...
            credentials: crate::util::weepcode_auth_credentials::WeepcodeAuthCredentials::new(
                Some(user_token.into()),
            ),
            session_id: None,
        }
    }
