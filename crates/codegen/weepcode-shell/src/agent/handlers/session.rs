...
pub async fn handle(
    ...
    match args.method.as_ref() {
        "weepcode/session/info" => handle_session_info(agent, args).await,
        "weepcode/session/close" => handle_session_close(agent, args).await,
        "weepcode/session/list" => handle_session_list(agent, args).await,
        "weepcode/sessions/list" => handle_roster_list(agent, args).await,
        m if m.starts_with("weepcode/session_summaries/") => {
...
async fn handle_session_summaries(
    ...
    match args.method.as_ref() {
        "weepcode/session_summaries/session_list" => {
        ...
        "weepcode/session_summaries/workspace_list" => {
        ...
        "weepcode/session_summaries/workspace_list_recent" => {
