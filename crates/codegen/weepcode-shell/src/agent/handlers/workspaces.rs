...
mod tests {
    ...
    #[test]
    fn success_response_projects_weepcode_workspace_fields() {
    ...
    fn degraded_response_carries_partial_reason() {
        ...
        assert_eq!(value["_meta"]["weepcode/partial"]["workspaces"], true);
        assert_eq!(value["_meta"]["weepcode/partial"]["reason"], "no_oauth");
    }
}
