...
pub(crate) type GatewayOut = <acp::AgentSide as weepcode_acp_lib::AcpSide>::OutMessage;
...
pub(crate) fn ctx_with_toggle(toggle: HashMap<String, bool>) -> SubagentSpawnContext {
    ...
    SubagentSpawnContext {
        ...
        fs: Arc::new(weepcode_workspace::file_system::LocalFs::new(
            PathBuf::from("/tmp"),
        )),
        ...
        auth_manager: Arc::new(crate::auth::AuthManager::new(
            std::path::Path::new("/tmp/nonexistent-weepcode-test"),
        ...
        parent_skills: None,
        parent_skills_config: weepcode_agent::prompt::skills::SkillsConfig::default(),
        parent_compat: weepcode_tools::types::compat::CompatConfig::default(),
        auto_wake_delivered: None,
        synthetic_trace_tx: None,
        task_output_tool_name: weepcode_tools::reminders::task_completion::DEFAULT_TASK_OUTPUT_TOOL
            .to_string(),
...
impl weepcode_tools::implementations::lsp::LspBackend for DummyLspDispatch {
    ...
    async fn dispatch(
        &self,
        _input: &weepcode_tools::implementations::lsp::LspToolInput,
    ) -> weepcode_tools::implementations::lsp::LspToolResult {
        weepcode_tools::implementations::lsp::LspToolResult {
            text: String::new(),
            is_error: false,
        }
    ...
    ) -> Option<weepcode_tools::implementations::lsp::DiagnosticsSummary> {
        None
    }
    ...
    ) -> Vec<weepcode_tools::implementations::lsp::FileDiagnosticEntry> {
        vec![]
    }
}
