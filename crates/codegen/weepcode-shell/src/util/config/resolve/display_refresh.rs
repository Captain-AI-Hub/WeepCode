...
pub const ENV_DISPLAY_REFRESH_PROBE_ENABLED: &str = "WEEPCODE_DISPLAY_REFRESH_PROBE_ENABLED";
pub const ENV_DISPLAY_REFRESH_AUTO_CADENCE: &str = "WEEPCODE_DISPLAY_REFRESH_AUTO_CADENCE";
...
/// Same band as env cadence knobs (`WEEPCODE_MIN_DRAW_MS` / `WEEPCODE_SCROLL_CADENCE_MS`).
