...
pub const ENV_SHOW_THINKING_BLOCKS: &str = "WEEPCODE_SHOW_THINKING_BLOCKS";
...
///
/// Precedence: requirements > env (`WEEPCODE_SHOW_THINKING_BLOCKS`) >
...
pub const ENV_GROUP_TOOL_VERBS: &str = "WEEPCODE_GROUP_TOOL_VERBS";
...
///
/// Precedence: requirements > env (`WEEPCODE_GROUP_TOOL_VERBS`) >
...
pub const ENV_COLLAPSED_EDIT_BLOCKS: &str = "WEEPCODE_COLLAPSED_EDIT_BLOCKS";
...
///
/// Precedence: requirements > env (`WEEPCODE_COLLAPSED_EDIT_BLOCKS`) >
...
///
/// Precedence: `WEEPCODE_MOUSE_REPORTING_TOGGLE` env > `[ui] mouse_reporting_toggle`
...
pub fn resolve_mouse_reporting_toggle(
    ...
    BoolFlag::env("WEEPCODE_MOUSE_REPORTING_TOGGLE")
...
mod tests {
    ...
    // Assumes WEEPCODE_MOUSE_REPORTING_TOGGLE is unset in the test env.
    #[test]
