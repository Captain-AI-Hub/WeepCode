...
//
// State is persisted to `~/.weepcode/claude_import_state.json`.
...
use weepcode_workspace::permission::claude_settings::find_claude_settings_paths;

// Types

/// Persistent import state, loaded from / saved to `~/.weepcode/claude_import_state.json`.
...
fn state_path() -> PathBuf {
    crate::util::weepcode_home::weepcode_home().join("claude_import_state.json")
}
