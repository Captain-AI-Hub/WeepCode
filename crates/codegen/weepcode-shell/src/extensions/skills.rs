...
use weepcode_agent::prompt::skills::{
...
fn discover_auto_sources(cwd: &str, skills: &[SkillInfo]) -> Vec<(String, usize)> {
    ...
    for subdir in &subdirs {
        try_add_source(weepcode_home.join(subdir), None);
    }
...
pub async fn handle(
    ...
    match args.method.as_ref() {
        "weepcode/skills/add" => {
            ...
            .await
            {
                weepcode_telemetry::session_ctx::log_event(
                    weepcode_telemetry::events::SkillAdded {
                        added_count: 0,
                        total_skills: 0,
                        success: false,
                    },
            ...
            weepcode_telemetry::session_ctx::log_event(weepcode_telemetry::events::SkillAdded {
        ...
        "weepcode/skills/remove" => {
            ...
            {
                weepcode_telemetry::session_ctx::log_event(
                    weepcode_telemetry::events::SkillRemoved { success: false },
                );
            ...
            weepcode_telemetry::session_ctx::log_event(weepcode_telemetry::events::SkillRemoved {
                success: true,
            });
