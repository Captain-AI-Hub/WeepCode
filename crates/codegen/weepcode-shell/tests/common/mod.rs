//! Shared helpers for weepcode-shell integration tests.

use weepcode_shell::sampling::{ApiBackend, Client, SamplerConfig};
...
pub fn test_sampler_config(
    ...
    // Shell `Client` is `weepcode_sampler::SamplingClient`, which takes a
