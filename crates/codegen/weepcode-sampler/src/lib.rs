//! weepcode-sampler - Actor-based sampling layer for WeepCode weepcode.
//!
//! This crate extracts the HTTP streaming + retry logic out of
//! `weepcode-shell`'s session actor into a standalone, reusable
//! component built on the same actor pattern as `weepcode-hunk-tracker`.
//!
//! ## Layered API
//!
