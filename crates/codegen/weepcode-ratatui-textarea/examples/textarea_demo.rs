...
//!
//! Run with: cargo run -p weepcode-ratatui-textarea --example textarea_demo
//!
...
use weepcode_ratatui_textarea::wrapping::{RtOptions, word_wrap_line};
use weepcode_ratatui_textarea::{
