//! WeepcodeNight theme — neutral gray base with TokyoNight accent colors.
//!
...
// WeepcodeNight palette — neutral gray base + TokyoNight accent colors.
//
...
mod tests {
    ...
    fn test_weepcodenight_theme() {
        let theme = Theme::weepcodenight();
