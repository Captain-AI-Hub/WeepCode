...
//!
//! In dev mode, watches ~/.weepcode/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.weepcode/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.weepcode/pager.toml, watches for changes
    ...
    fn start_static() -> io::Result<Self> {
        let config = weepcode_config::user_weepcode_home()
