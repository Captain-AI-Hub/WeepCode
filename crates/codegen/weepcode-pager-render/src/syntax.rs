...
//! Dark themes (WeepcodeNight, TokyoNight) share `weepcode-night.tmTheme`;
//! WeepcodeDay uses `weepcode-day.tmTheme` with deepened colors for light backgrounds.

use std::sync::OnceLock;

pub use weepcode_markdown::Syntect;
