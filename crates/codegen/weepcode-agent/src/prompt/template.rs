...
/// The base prompt template source, exposed for `weepcode prompt --section template`.
...
/// Apply-patch prompt template source, exposed for `weepcode prompt --section apply-patch-template`.
...
mod tests {
    ...
    /// Build a TemplateRenderer with the standard weepcode-build tool kinds.
