...
//!   here would force every consumer of `weepcode-workspace-types`
...
//! (`weepcode-workspace`) wraps this in its own `Request<T>` that
//! adds the cancellation token and extensions map.
//!
//! Splitting the envelope this way keeps `weepcode-workspace-types`
