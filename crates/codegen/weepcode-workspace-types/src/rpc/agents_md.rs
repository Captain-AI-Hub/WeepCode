...
/// Claude.md / `.weepcode/rules/*.md`) discovered from the workspace root up to
/// the git root, plus `~/.weepcode` and compat dirs.
...
/// Mirrors the serde shape of `weepcode-agent`'s `AgentConfigFile`.
