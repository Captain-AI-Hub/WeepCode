//! Tracing layer for `target: "sampling_log"` → `~/.weepcode/logs/sampling.jsonl`.
//! Enable with `--log-sampling` or `WEEPCODE_LOG_SAMPLING=1`.
...
const ENV_VAR: &str = "WEEPCODE_LOG_SAMPLING";
