...
pub const LOG_METHOD: &str = "weepcode/log";
...
pub enum LogSource {
    ...
    #[serde(rename = "shell")]
    Shell,
    #[strum(serialize = "weepcode-pager")]
    #[serde(rename = "weepcode-pager")]
    WeepcodePager,
    #[strum(serialize = "weepcode-desktop")]
    #[serde(rename = "weepcode-desktop")]
    WeepcodeDesktop,
}
...
fn log_path() -> PathBuf {
    weepcode_home().join(LOG_DIR).join(LOG_FILE)
}
