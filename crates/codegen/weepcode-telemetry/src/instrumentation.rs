...
const ENV_ENABLED: &str = "WEEPCODE_INSTRUMENTATION";
const ENV_LOG_PATH: &str = "WEEPCODE_INSTRUMENTATION_LOG";
const DEFAULT_LOG_DIR: &str = "logs";
const DEFAULT_LOG_FILE: &str = "instrumentation.log";
const DEFAULT_TRACE_FILE: &str = "instrumentation.trace.json";

pub const TARGET: &str = "weepcode_instrumentation";
...
fn default_log_path() -> PathBuf {
    weepcode_home().join(DEFAULT_LOG_DIR).join(DEFAULT_LOG_FILE)
}
...
fn default_output_path(mode: InstrumentationMode) -> PathBuf {
    let root = weepcode_home().join(DEFAULT_LOG_DIR);
    match mode {
