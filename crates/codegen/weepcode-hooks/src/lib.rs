//! # weepcode-hooks
//!
//! Runtime hook system for WeepCode — file-based discovery, command execution,
//! and policy enforcement.
//!
//! ## Overview
//!
//! This crate provides a minimal hooks system for WeepCode. Hooks are discovered
//! from dedicated directories (`~/.weepcode/hooks/` and `<git-worktree-root>/.weepcode/hooks/`),
...
//!     Some(Path::new("/home/user/.weepcode/hooks")),
//!     Some(Path::new("/project/.weepcode/hooks")),
//! );
//!
//! for err in &errors {
