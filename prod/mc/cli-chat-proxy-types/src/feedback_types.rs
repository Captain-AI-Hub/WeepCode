...
//!
//! These types support the feedback collection system for WeepCode sessions.
//! The agent (weepcode-shell) uses heuristics to determine when to request feedback,
...
fn default_tier1_prompt() -> String {
    "You've been using WeepCode Code productively! Would you mind sharing quick feedback?"
        .to_string()
}
